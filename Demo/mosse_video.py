...
Usage:
    mosse_video.py [--shotdir <shot path>] [source0] [source1] ...'
...
# local modules
from mosse_tst_scene_render import TestSceneRender
import mosse_common
...
class Chess(VideoSynthBase):
    ...
    def render(self, dst):
        ...
        R, self.tvec = mosse_common.lookat(eye_pos, target_pos)
        self.rvec = mosse_common.mtx2rvec(R)
